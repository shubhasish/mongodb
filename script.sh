...
docker run -P --name ttnd1 --hostname="$h1" -d shashanp/mongodb --replSet ttnd --noprealloc --smallfiles
docker run -P --name ttnd2 --hostname="$h2" -d shashanp/mongodb --replSet ttnd --noprealloc --smallfiles
docker run -P --name ttnd3 --hostname="$h3" -d shashanp/mongodb --replSet ttnd --noprealloc --smallfiles
